...
class PushNotification implements ApiEntityInterface
{
    ...
    {
        return $this->pushNotificationRecipients->count();
    }
    ...
    {
        return $this->pushNotificationRecipients->filter(function(Recipient $recipient) {
            return $recipient->getSent();
        })->count();
    }
    ...
    {
        return $this->pushNotificationRecipients->filter(function(Recipient $recipient) {
            return $recipient->getOpened() !== null;
        })->count();
    }
}
