...
/***/ "./Resources/assets/js/notifications/notifications.js":
/*!************************************************************!*\
  !*** ./Resources/assets/js/notifications/notifications.js ***!
  \************************************************************/
...
function htmlEditorChanged(trumbowyg) {
  var text = trumbowyg.val();
  var template = $('textarea#html-template').val();
  var webview = template.replace('{{ CONTENT }}', text);
  var row = trumbowyg.closest('.row');
  var iframe = row.find('.html-preview .content iframe')[0].contentWindow.document;
  iframe.open();
  iframe.close();
...
$(document).ready(function () {
  ...
  var scheduleCheckbox = $('#push_notification_form_schedule');
  ...
  var testingCheckbox = $('#push_notification_form_test');
  ...
  function formIsValid() {
    ...
    var fallback = $('.is-fallback-language');
    ...
    var clickAction = $('select.click-action').val();
    ...
    var segment = $('#push_notification_form_segment');
    ...
    if ($('input#push_notification_form_schedule').is(':checked')) {
      var date = $('input#push_notification_form_scheduledSending_date');
      var time = $('input#push_notification_form_scheduledSending_time');
      ...
      var dateRegex = /[0-3]{1}[0-9]{1}-[0-1]{1}[0-9]{1}-[2-9]{1}[0-9]{3}/;
      var timeRegex = /[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}/;
  ...
  function formIsConsistent() {
    var consistent = true;
    $('ul.message-inconsistent').remove(); // Get the total amount of languages

    var languageCount = $('li.tab').length;
    var titleCount = languageCount - countEmptyFields('input.title'); // User has not provided a title for all languages
    ...
    var contentCount = languageCount - countEmptyFields('input.content'); // User has not provided a title for all languages
    ...
    if (clickAction > 0) {
      ...
      var element = clickAction === '1' ? 'input.click-action-url' : 'textarea.click-action-html';
      var isHtml = clickAction === '2';
      var clickActionCount = languageCount - countEmptyFields(element); // User has not provided a click action for all languages

      if (clickActionCount > 0 && clickActionCount < languageCount) {
        // Get the correct element for the message placement
        var beforeElement = isHtml ? '.trumbowyg-box' : element;
  ...
  function submitForm() {
    ...
    var html = translations.confirmationContent + '\n\n';
    $.ajax({
      ...
      success: function success(response) {
        ...
        if ($('#push_notification_form_segment').val() == 0 || typeof $('#push_notification_form_segment').val() === 'undefined') {
          var isTest = $('#push_notification_form_test:checked').length > 0;
          var translated = isTest ? translations.selectedTestDevices : translations.allDevices;
...
/***/ 9:
/*!******************************************************************!*\
  !*** multi ./Resources/assets/js/notifications/notifications.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/thomasroovers/Developer/Homestead/Pronto/MobileBundle/Resources/assets/js/notifications/notifications.js */"./Resources/assets/js/notifications/notifications.js");
