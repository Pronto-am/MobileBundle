...
$(document).ready(function () {
    ...
    function formIsConsistent() {
        ...
        var titleCount = languageCount - countEmptyFields('input.title');
        ...
        var contentCount = languageCount - countEmptyFields('input.content');
        ...
        if (clickAction > 0) {
            ...
            var clickActionCount = languageCount - countEmptyFields(element);
...
module.exports = __webpack_require__("./Resources/assets/js/notifications/notifications.js");
