...
$(document).ready(function () {
  ...
  $('a[name="add-select-option"]').click(function () {
    var selectOption = $(this).closest('.col.s12').find('.select-option:first-child').clone(); // Get the count of current options

    var count = $(this).closest('.col.s12').find('.select-option').length; // Update the field count
    ...
    valueInput.attr('name', valueInput.attr('name').replace('value-1', 'value-' + parseInt(count + 1))); // Insert info message
